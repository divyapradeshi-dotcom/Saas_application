  ...
  return (
    <header
      className={clsx(
        ...
        hasScrolled && "py-2 bg-black/80 backdrop-blur-md"
      )}
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2">
          <img src="/images/xora.svg" width={55} alt="logo" />
        </a>
        ...
        >
          <div
            ...
            max-md:px-4"
          >
            <nav className="max-lg:relative max-lg:z-50 max-lg:my-auto">
        ...
        <button
          className="lg:hidden z-50 w-10 h-10 border-2 border-s4/25
