            ...
            <div className="container">
                ...
                max-md:border-none max-md:rounded-none max-md:gap-3">
                    ...
                    ({id,icon, caption,title,text ,button})=> (
                        <div key={id} className="relative z-2 md:px-10 px-5 md:pb-5 pb-5 flex-50
                        max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320"
                            ...
                            <p className="caption mb-5 max-md:mb-6 ">{caption}
                            </p>
                     ...
                     <ul className="relative flex justify-around flex-grow px-[5%]
  border-2 border-s3 rounded-7xl mx-md:hidden">
  <li className="absolute bg-s3/20 top-[38%] left-0 right-0
    w-full h-[1px] z-10"
  />
...
>
 ...
 <h3 className="relative z-2 max-w-36 max-auto my-0
 base-small text-center uppercase">{title}</h3>
